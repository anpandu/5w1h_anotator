...
@section('content')
    ...
    <div class="col-sm-10">
        <div class="row">
            ...
            <div class="col-sm-5">
                <h1>5W1H</h1>
                <form class="form-horizontal" role="form" method="POST" action="/info/edit/{{$info->id}}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                                <input type="text" class="form-control" id="inputWhat" placeholder="What" name="what" value="{{$info->what}}">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="inputTitle" class="col-sm-2 control-label">Who</label>
                        <div class="col-sm-10">
                                <input type="text" class="form-control" id="inputWho" placeholder="Who" name="who" value="{{$info->who}}">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                                <textarea id="inputText" class="form-control" rows="5" placeholder="Why" name="why">{{$info->why}}</textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="inputText" class="col-sm-2 control-label">How</label>
                        <div class="col-sm-10">
                                <textarea id="inputText" class="form-control" rows="5" placeholder="How" name="how">{{$info->how}}</textarea>
                        </div>
                    </div>
                    <div class="form-group">
